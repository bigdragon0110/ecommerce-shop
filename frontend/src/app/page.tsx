...
type RowProps={title:string;promo:SectionPromo;data:Product[];connected?:boolean;simple?:boolean;indicators?:boolean;controls?:"plus"|"arrows-plus"};
function ProductRow({title,promo,data,connected,simple,indicators,controls="arrows-plus"}:RowProps){return <div className={connected ? "" : "border-t border-[#e9e9e9]"}>
...
export default async function Home(){
  ...
  <ProductRow title="Recommended products" promo={sectionPromos.featuredRecommended} data={relatedProductData} connected simple />
  ...
  <ProductRow title="Hit products" promo={sectionPromos.hit} data={hitData} controls="arrows-plus" />
  <ProductRow title="Recommended products" promo={sectionPromos.recommended} data={relatedProductData} indicators />
  <ProductRow title="New products" promo={sectionPromos.newProducts} data={newArrivalsData} />
  <ProductRow title="Popular products" promo={sectionPromos.popular} data={topSellingData} />
  <ProductRow title="Discounted products" promo={sectionPromos.sale} data={saleData} controls="arrows-plus" />
</main>}

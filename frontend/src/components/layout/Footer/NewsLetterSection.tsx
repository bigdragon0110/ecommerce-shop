...
const NewsLetterSection = () => {
  return (
    <div className="relative grid grid-cols-1 md:grid-cols-2 py-9 md:py-11 px-6 md:px-16 max-w-frame mx-auto bg-[#181818] border border-white/10 rounded-none">
      <p
        className={cn([
          integralCF.className,
          "font-bold text-[28px] md:text-[38px] leading-tight text-white mb-9 md:mb-0 max-w-[520px]",
        ])}
      >
